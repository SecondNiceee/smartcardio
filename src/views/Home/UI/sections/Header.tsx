      ...
      <header className="overflow-x-clip max-w-[100vw]">
        <div className="relative z-20">
          <div className="max-w-[1480px] flex mx-auto px-5 mt-5 justify-between items-center">
            <h2 className="font-bold text-[clamp(1.063rem,0.388rem+1.4vw,1.688rem)] tracking-[0.02em] uppercase text-white">
              SmartCardio
            </h2>
                ...
                return (
                  <React.Fragment key={i}>
                    {headerNav.path ? (
                      <Link
                        href={headerNav.path}
                        className="font-normal text-[clamp(0.813rem,0.692rem+0.6vw,1.25rem)] text-white list-none cursor-pointer"
                      >
                        {headerNav.value}
                      </Link>
                    ) : (
