...
const ForWhomTwo = () => {
  ...
  return (
    <section
      id="forwhom"
      className="overflow-x-clip max-w-[100vw] relative"
    >
      <div className="max-w-[1310px] mx-auto px-5 gap-[clamp(1.875rem,1.53rem+1.72vw,3.125rem)] py-[clamp(1.25rem,0.625rem+3.6vw,3.125rem)] flex flex-col items-center">
        <ForWhomTitleSlider
          setSliderIndex={setActiveSlideIndex}
        ...
        <div className="flex w-full relative">
          ...
          <div className="lg:w-[31%] flex my-auto justify-center">
            <PrevButton
              className="lg:w-full md:hidden top-[32%] md:top-1/2 left-0 z-20 -translate-y-1/2 absolute lg:relative prev-forWhom lg:scale-150"
              arrowType="circle"
            />
            <NextButton
