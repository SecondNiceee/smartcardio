export const frequentQuestions = [
  {
    title: (
      <h2 className="font-semibold text-[clamp(1.125rem,0.981rem+0.64vw,1.438rem)] leading-[175%] text-left text-white">
    ...
    answer: (
      <div className="flex flex-col gap-1">
        <p className="font-normal text-[clamp(1rem,0.913rem+0.38vw,1.188rem)] leading-[175%] text-left text-white !font-semibold">Нет.</p>
        <p className="font-normal text-[clamp(1rem,0.913rem+0.38vw,1.188rem)] leading-[175%] text-left text-white">
        ...
        <p className="font-normal text-[clamp(1rem,0.913rem+0.38vw,1.188rem)] leading-[175%] text-left text-white"> Дополнительных подписок или платных функций <span className="!font-semibold">не требуется.</span></p>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <div className="flex flex-col gap-1">
        <p className="font-normal text-[clamp(1rem,0.913rem+0.38vw,1.188rem)] leading-[175%] text-left text-white">В настройках вы можете выбрать:</p>
        <p className="font-normal text-[clamp(1rem,0.913rem+0.38vw,1.188rem)] leading-[175%] text-left text-white">
  ...
  {
    title: (
      <h2 className="font-semibold text-[clamp(1.125rem,0.981rem+0.64vw,1.438rem)] leading-[175%] text-left text-white">Работает ли СмартКардио® с iPhone?</h2>
    ),
    answer: (
      <div className="flex flex-col gap-1">
        <p className="font-normal text-[clamp(1rem,0.913rem+0.38vw,1.188rem)] leading-[175%] text-left text-white !font-semibold">Да.</p>
        <p className="font-normal text-[clamp(1rem,0.913rem+0.38vw,1.188rem)] leading-[175%] text-left text-white">
  ...
  {
    title: (
      <h2 className="font-semibold text-[clamp(1.125rem,0.981rem+0.64vw,1.438rem)] leading-[175%] text-left text-white">Как проверяется точность прибора?</h2>
    ),
    answer: (
      <p className="font-normal text-[clamp(1rem,0.913rem+0.38vw,1.188rem)] leading-[175%] text-left text-white">
  ...
  {
    title : (
      <h2 className="font-semibold text-[clamp(1.125rem,0.981rem+0.64vw,1.438rem)] leading-[175%] text-left text-white">Заменяет ли автоматический анализ ЭКГ прием у врача?</h2>
    ),
    answer : (
      <div className="flex flex-col gap-1">
        <p className="font-normal text-[clamp(1rem,0.913rem+0.38vw,1.188rem)] leading-[175%] text-left text-white !font-semibold">Нет.</p>
